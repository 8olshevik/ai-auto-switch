...
// TODO: Replace Call.ByName with HTTP API calls (task 6.3)
...
const loadSettings = async () => {
  try {
    ...
    console.warn('[stub] NetworkService.GetNetworkSettings not yet implemented')
...
const detectWsl = async () => {
  try {
    // TODO: Replace with HTTP API call (task 6.3)
    console.warn('[stub] NetworkService.DetectWSL not yet implemented')
...
const saveSettings = async () => {
  try {
    // TODO: Replace with HTTP API call (task 6.3)
    console.warn('[stub] NetworkService.SaveNetworkSettings not yet implemented')
  } catch (error) {
...
const handleListenModeChange = async () => {
  ...
  if (listenMode.value === 'wsl_auto') {
    try {
      // TODO: Replace with HTTP API call (task 6.3)
      console.warn('[stub] NetworkService.GetWSLHostAddress not yet implemented')
    } catch (error) {
...
const handleConfigureNow = async () => {
  ...
  try {
    // TODO: Replace with HTTP API call (task 6.3)
    console.warn('[stub] NetworkService.ConfigureWSLClients not yet implemented')
