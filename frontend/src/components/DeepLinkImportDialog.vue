...
// TODO: Replace with HTTP API calls (task 6.3)
// Deep link import will be replaced with URL parameter import in web app
async function ParseDeepLinkURL(url: string): Promise<any> {
  console.warn('[stub] ParseDeepLinkURL not yet implemented - deep links replaced by URL params in web app')
  return null
}
async function ImportProviderFromDeepLink(request: any): Promise<any> {
  console.warn('[stub] ImportProviderFromDeepLink not yet implemented')
  return null
}
