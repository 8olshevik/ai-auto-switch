...
async function CheckEnvConflicts(platform: string): Promise<EnvConflict[]> {
  console.warn('[stub] CheckEnvConflicts not yet implemented')
  return []
}
// Type definition previously from bindings
