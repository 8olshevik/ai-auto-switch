...
// TODO: Tray page is deprecated in web app (no system tray)
...
const resizeToContent = async () => {
  ...
  // NOTE: Tray window operations not applicable in web app
  // This component is deprecated (no system tray in web app)
}
